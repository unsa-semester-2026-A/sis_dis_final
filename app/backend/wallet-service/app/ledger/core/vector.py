...
from app.shared import EntityId, InvalidAmountError
...
class Vector:
    ...
    def __post_init__(self) -> None:
        ...
        Raises:
            ...
            ValueError: If source and target nodes are the same or the exchange
    ...
    def target_amount(self) -> Decimal:
        ...
        Returns:
            Decimal: The converted target amount.
        """
